    ...
    <div className="flex justify-between items-center h-screen px-8">
      ...
      <div className="flex h-3/4 w-2/3 flex-col justify-center items-center space-y-2 text-blue-400">
        ...
        <div className="space-x-4">
          {/* Link to Register */}
          <Link to="/register">
            <button className="bg-gradient-to-r from-orange-400 to-red-500 hover:from-red-500 hover:to-orange-400 text-white py-2 px-6 rounded-lg shadow-lg transition duration-300 transform hover:scale-105">Register</button>
          </Link>
          {/* Link to Events */}
          <Link to="/events">
