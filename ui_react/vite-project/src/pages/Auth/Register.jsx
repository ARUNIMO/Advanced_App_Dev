    ...
    <div className="max-w-md mx-auto mt-10 flex flex-col p-4 rounded-md text-black bg-gradient-to-b from-orange-200 to-white shadow-md">
      ...
      <form className="flex flex-col gap-3">
        ...
        <div className="block relative"> 
          ...
          <input type="password" id="confirmPassword" className="rounded border border-gray-200 text-sm w-full font-normal leading-[18px] text-black tracking-[0px] appearance-none block h-11 m-0 p-[11px] focus:ring-2 ring-offset-2 ring-gray-900 outline-0" />
        </div>
        <button type="submit" className="bg-[#f35415] w-max mx-auto px-6 py-2 rounded text-white text-sm font-normal">Register</button>
      </form>
      <div className="text-sm text-center mt-[1.6rem]">Already have an account? <Link to="/login" className="text-sm text-[#f35415]">Log in here</Link></div>
    </div>
  );
}
